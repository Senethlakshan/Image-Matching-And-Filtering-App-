...
// Define the path to the existing "fildataset" folder
const filterDataPath = 'C:\Users\senethg\Downloads\art';
    ...
    if (imageFiles.length > 0) {
      ...
      imageFiles.forEach((file, index) => {
        ...
        fs.readFile(imagePath, (err, data) => {
          ...
          lastImageCount = index + 1;
          if (lastImageCount === imageFiles.length) {
            console.log('Last image count:', lastImageCount);
          }
        });
      });
    } else {
